        ...
        <div class="grid px-5 grid-cols-9 h-full justify-center  lg:px-4  ">
            ...
            <div class="lg:col-span-5 col-span-9  text-white">
                <div class="--presell-box py-8">
                    ...
                    <div class="text-white text-center">Lorem ipsum dolor sit amet, cunc faucibus. Ultrices at a. </div>
                    <div class="w-3/4 px-3 mt-4 mx-auto">
                        ...
                        <div
                            class="mt-0   text-yellow-300  border-yellow-300 border-solid  text-xs py-1 !text-right relative">
